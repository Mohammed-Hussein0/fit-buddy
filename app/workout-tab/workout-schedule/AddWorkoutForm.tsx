        ...
        {DAYS_INIT.map((day, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              style={[
                styles.dayOption,
                selectedDay === index && styles.dayOptionSelected,
                isOccupied && styles.dayOptionDisabled,
                {
                  backgroundColor:
                    selectedDay === index ? "#000" : colors.background,
                },
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  selectedDay === index && styles.dayOptionTextSelected,
                  isOccupied && styles.dayOptionTextDisabled,
                  {
                    color:
                      selectedDay === index ? "#fff" : colors.secondaryText,
                  },
                ]}
              >
                {day}
...
const styles = StyleSheet.create({
  ...
  charLimit: { fontSize: 10, fontWeight: "700" },
  noteInput: {
    fontSize: 15,
    fontWeight: "500",
    padding: 12,
  ...
  dayOptionText: { fontWeight: "800", fontSize: 13 },
